...
const App: FC = () => {
  ...
  async function getBackground() {
    return fetch(`${WEB_COMPONENT_API_ENDPOINT}/api/components/paste/promotion`, {
      method: "GET",
      credentials: "include",
    })
      .then((response) =>
  ...
  return (
    <HelmetProvider>
      <Suspense fallback={<Loader />}>
        ...
        <Routes>
          <Route path="/new" element={<NewPaste background={background} />} />
          <Route path="/:id" element={<ShowPaste background={background} />} />
